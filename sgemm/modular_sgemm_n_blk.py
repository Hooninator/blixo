...
#microkernel sizes
N_r = 4
M_r = 16 #NOTE: This must be divisible by 4
#block sizes
M_c = 64 
K_c = 64
N_c = 64
...
GEBP = (GEBP_MKc
        ...
        .split('j', N_c, ['jo', 'ji'], tail='cut_and_guard')
        #Handle edge case
        ...
        .split('ji', M_r, ['joo', 'jii'], tail='cut_and_guard')
        .reorder('jii', 'ii')
        .stage_mem(f'B[0:{K_c}, {N_c}*jo:{N_c}*jo+{N_c}]', 'B_blk', 'for joo in _:_ #0')
